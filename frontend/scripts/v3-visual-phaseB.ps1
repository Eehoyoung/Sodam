...
$ids = @(
  "sodam-v3-03-employee--023",
  "sodam-v3-03-employee--025",
  "sodam-v3-03-employee--045",
  "sodam-v3-03-employee--058",
  "sodam-v3-03-employee--059",
  "sodam-v3-02-owner--008",
  "sodam-v3-02-owner--010",
  "sodam-v3-02-owner--011",
  "sodam-v3-02-owner--012",
  "sodam-v3-02-owner--013",
  "sodam-v3-02-owner--014",
  "sodam-v3-02-owner--015",
  "sodam-v3-02-owner--016",
  "sodam-v3-02-owner--017",
  "sodam-v3-02-owner--018",
  "sodam-v3-02-owner--046",
  "sodam-v3-02-owner--153"
)
$outputRoot = "C:\Users\LeeHoYoung\Downloads\Project_sodam\artifacts\v3-visual"
$logFile = Join-Path $outputRoot "phaseB-log.txt"
