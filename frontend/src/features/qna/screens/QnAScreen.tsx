...
const faqData = [
    {id: '1', question: '소담 서비스는 어떤 서비스인가요?', answer: '소담은 아르바이트 근태 및 급여 관리를 위한 서비스입니다. 사장님은 직원들의 출퇴근 관리와 급여 계산을 쉽게 할 수 있고, 직원들은 자신의 근무 시간과 급여를 확인할 수 있습니다.'},
    {id: '2', question: '소담 서비스는 어떻게 이용할 수 있나요?', answer: '회원가입 후 사장님 또는 직원으로 역할을 선택하여 이용할 수 있습니다. 사장님은 매장을 등록하고 직원을 초대할 수 있으며, 직원은 초대를 받아 매장에 소속되어 근무할 수 있습니다.'},
    {id: '3', question: '서비스 이용 요금은 어떻게 되나요?', answer: '기본 서비스는 무료로 이용 가능하며, 추가 기능을 원하시는 경우 구독 서비스를 이용하실 수 있습니다. 자세한 요금 정보는 구독 페이지에서 확인하실 수 있습니다.'},
    {id: '4', question: '출퇴근 기록은 어떻게 관리되나요?', answer: '직원은 앱을 통해 출퇴근 시간을 기록할 수 있으며, 사장님은 이를 실시간으로 확인하고 관리할 수 있습니다. GPS 기반 위치 확인 기능도 제공됩니다.'},
    ...
    {id: '8', question: '앱을 사용하다가 오류가 발생했어요.', answer: '앱 사용 중 오류가 발생한 경우, 1:1 문의 또는 카카오 채팅 문의를 통해 문제를 알려주시면 신속하게 해결해 드리겠습니다.'},
];
...
const QnAScreen: React.FC = () => {
    ...
    const handleInquirySubmit = () => {
        ...
        Alert.alert('문의가 접수되었습니다', '빠른 시일 내에 답변 드리겠습니다.', [
            {
                text: '확인',
                onPress: () => {
                    setInquiryName('');
